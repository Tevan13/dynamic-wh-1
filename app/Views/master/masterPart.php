        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col">
              ...
              <a href='<?= base_url('Partnumber/export'); ?>' class="btn btn-success">Export Excel</a>
              |
              ...
              <tr>
                ...
                <td style="text-align: center;">
                  <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                    data-bs-target="#ModalUpdate<?= $part['idPartNo'] ?>">
                    Edit
                  </button>
                  <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                    data-bs-target="#ModalDelete<?= $part['idPartNo'] ?>">
                    Delete
                  </button>
                </td>

                <!-- Modal Edit -->
                <div class=" modal fade" id="ModalUpdate<?= $part['idPartNo'] ?>" tabindex="-1"
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form id="form-update" action="<?= base_url(); ?>/master-part/<?= $part['idPartNo'] ?>"
                          method="POST">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="number" name="max_kapasitas" class="form-control"
                              value="<?= $part['max_kapasitas'] ?>" required>
                          </div>
                          <div class="mb-3">
                            ...
                            <select class="form-select" id="tipe_rak" name="tipe_rak">
                              ...
                              <option value="Over Area" <?= $part['tipe_rak'] == 'Over Area' ? 'selected' : '' ?>>Over Area
                              </option>
                            </select>
                          </div>
                          <div class="modal-footer">
                ...
                <!-- Modal Delete -->
                <div class=" modal fade" id="ModalDelete<?= $part['idPartNo'] ?>" data-modal-id="<?= $part['idPartNo'] ?>"
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="<?= base_url('') ?>/master-part/<?= $part['idPartNo'] ?>" method="POST"
                          id="form-delete">
                          ...
                          <div class="mb-3">
                            <label class="form-label">Kapasitas Maximum</label>
                            <input type="text" name="max_kapasitas" class="form-control"
                              value="<?= $part['max_kapasitas'] ?>" required readonly>
                          </div>
                          <div class="mb-3">
                            <label class="form-label">Jenis Rak</label>
                            <input type="text" name="tipe_rak" class="form-control" value="<?= $part['tipe_rak']; ?>"
                              required readonly>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary mr-2" data-bs-dismiss="modal">Close</button>
